(function (window, document) {
  ...
  app.elements = {
    ...
    pointContributorModal: document.querySelector("#point-contributor-modal"),
    pointContributorBackdrop: document.querySelector("#point-contributor-backdrop"),
    pointContributorClose: document.querySelector("#point-contributor-close"),
    pointContributorTitle: document.querySelector("#point-contributor-title"),
    pointContributorBody: document.querySelector("#point-contributor-body"),
  ...
  app.state = {
    ...
    latestLiveSweats: [],
    latestManagers: [],
    latestPointsChangeComparisonDate: "",
    liveSweatsCountdownTimerId: 0,
    playerHistoryCache: null,
    comparisonSnapshotCache: {},
